...
/**
 * The MonitoringStatus contains several data structures used to save runtime data and
...
public class MonitoringStatus {
	...
	/**
	 * Constructor for the MonitoringStatus class. Initializes empty data structures and
	 * sets the total consumed energy to zero.
	 */
	 ...
	 * @param methodName a String, the filtered method name to which the consumption is
	 * mapped
	 * @param delta a double, the amount of energy to be added
	 */
	...
	/**
	 * Tracks the method's energy consumption over the time. Maps the given UNIX timestamp
	 * to the given energy consumption for the given method name. Creates or update the
	...
	public void trackMethodConsumption(String methodName, long timestamp, double energy) {
		if (!this.methodsConsumptionEvolution.containsKey(methodName)) {
			// Creating a new map for tracking the method's energy consumption over the
			// time
	...
	/**
	 * Tracks the filtered method's energy consumption over the time. Maps the given UNIX
	 * timestamp to the given energy consumption for the given method name. Creates or
	 * update the needed data structures.
	 * @param methodName a String, the name of the method
	 * @param timestamp a long representing an UNIX timestamp
	 * @param energy a double, the method energy consomption
	 */
	 ...
	 * @return a Map<String, Double> mapping method's name to their respective energy
	 * consumption.
	 */
	 ...
	 * @return a Map<String, Double> mapping filtered method's name to their respective
	 * energy consumption.
	 */
	 ...
	 * @return a Map<String, Map<Long,Double>> mapping each method's name to their
	 * consumption evolution. Consumption evolution is stored as a Map<Long,Double>
	 * mapping UNIX timestamps to energy consumption.
	 */
	 ...
	 * @return a Map<String, Map<Long,Double>> mapping each filtered method's name to
	 * their consumption evolution. Consumption evolution is stored as a Map<Long,Double>
	 * mapping UNIX timestamps to energy consumption.
	 */
	 ...
	 * @return a Map<CallTree, Double> mapping each call tree to their total energy
	 * consumption.
	 */
	 ...
	 * @return a Map<CallTree, Double> mapping each filtered call tree to their total
	 * energy consumption.
	 */
