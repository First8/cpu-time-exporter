...
/**
 * A CallTree (or a stack trace) is a collection of StackTraceElements in a given order.
 * This class proivdes methods in order to easily represent and manage such stack traces.
 */
public class CallTree {
	 ...
	 * This array will be automatically converted to a List.
	 */
	...
	public String toString() {
		...
		/*
		 * Appening elements to res String in reverse order. The least recent element (the
		 * bottom of the stack trace) will be written first, and the most recent one last.
		 */
	...
	/**
	 * Custom implementation of the hashCode method for StackTraceElement. The hashCode is
	 * computed based on the class, the method and the file of the given element (if
	 * available). Custom hashCode does NOT take into account the line number.
	...
	/**
	 * Custom implementation of the equals method for call trees Two callTrees are equals
	...
	/**
	 * Custom implementation of the equals method for StackTraceElement Two
	 * StackTraceElement are equals if they have the same file name (if available), class
	 * name and method name. Please note that the line number is NOT checked, and if the
	 * three previous conditions are satisfied, two StackTraceElement with a different
	 * line number will be considered equals.
	 * @param e a StackTraceElement
	 * @param other a StackTraceElement
	 * @return a boolean, true if the two given StackTraceElement are equals, false
	 * otherwise
	 */
	private boolean equals(StackTraceElement e, StackTraceElement other) {
		...
		return result && e.getClassName().equals(other.getClassName())
				&& e.getMethodName().equals(other.getMethodName());
	}
