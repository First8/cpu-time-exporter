...
public class AgentProperties {
	...
	public boolean loadConsumptionEvolution() {
		return true;// Boolean.parseBoolean(properties.getProperty(TRACK_CONSUMPTION_EVOLUTION_PROPERTY));
	}
	...
	public boolean loadCallTreesConsumption() {
		return true; // Boolean.parseBoolean(properties.getProperty(CALL_TREES_CONSUMPTION_PROPERTY));
	}

	public boolean loadSaveCallTreesRuntimeData() {
		return true;// Boolean.parseBoolean(properties.getProperty(SAVE_CT_RUNTIME_DATA_PROPERTY));
	}

	public boolean loadOverwriteCallTreeRuntimeData() {
		return true; // Boolean.parseBoolean(properties.getProperty(OVERWRITE_CT_RUNTIME_DATA_PROPERTY));
	}
