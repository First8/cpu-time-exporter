...
public class StackTraceFilter {
	...
	/**
	 * Filters the elements of a stack trace using the given predicate, based on the class
	 * and method names of the elements.
	 ...
	 * @return a List of StackTraceElement, representing the filtered stack trace. The
	 * order of the elements will be the same as the input array, but the list will only
	 * contains elements that pass the filter.
	 */
